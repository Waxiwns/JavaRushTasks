...
/* 
Знания - сила! Stock:
1. В методе sort написать компаратор для
        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (name1.compareTo(name2) == 0){
                    ...
                    String date1 = simpleDateFormat.format(stock1.get("date"));
                    String date2 = simpleDateFormat.format(stock2.get("date"));
                    if (date1.compareTo(date2) == 0){
                        ...
                        Double res1 = open1 - last1;
                        Double res2 = open2 - last2;
