...
public class Solution {
    ...
    protected void initThreads() {
        this.thread1 = new Thread(new Task(this, "A\tB\tC\tD\tE\tF\tG\tH\tI"), FIRST_THREAD_NAME); // (this, "A\tB\tC\tD\tE\tF\tG\tH\tI")
        this.thread2 = new Thread(new Task(this, "J\tK\tL\tM\tN\tO\tP\tQ\tR\tS\tT\tU\tV\tW\tX\tY\tZ"), SECOND_THREAD_NAME); // (this, "J\tK\tL\tM\tN\tO\tP\tQ\tR\tS\tT\tU\tV\tW\tX\tY\tZ")
        this.thread3 = new Thread(new Task(this, "\t\t"), "3#"); // (new Task(this, "\t\t"), "3#")
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        try {
            ...
            int fin = string.lastIndexOf("\t");
            String s = string.substring(start, fin);
            return s;
        }
        catch (Exception e){
