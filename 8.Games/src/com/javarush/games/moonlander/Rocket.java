...
public class Rocket extends GameObject {
    ...
    private RocketFire downFire;    // нижняя тяга
    private RocketFire leftFire;    // левая тяга
    private RocketFire rightFire;   // правая тягя
    ...
    public void move(boolean isUpPressed, boolean isLeftPressed, boolean isRightPressed) {
        ...
        if (isLeftPressed) {
            ...
            speedX += boost;
            x += speedX;
        } else if (speedX > slowdown) {         // плавное торможение
            speedX -= slowdown;
    ...
    // остановка если скорось больше чем надо при сталкновении с платформой
